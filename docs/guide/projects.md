...
## Users
To allow collaboration on development of Dialogs and Bots, additional users can be added to the project. Currently all added users have administration privilidges on the project.